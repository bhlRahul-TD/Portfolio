export const Bio = {
  ...
  description:
    "Dynamic and proactive software professional with over 2 years of experience in the IT sector, known for consistently meeting company goals through organized practices, dedication, and the ability to thrive under pressure. Passionate about technology and committed to continuous learning and improvement. Eager to contribute my technical and analytical proficiency to innovative projects, my goal is to excel in my role, make a meaningful impact on the organization, and embrace opportunities for growth in the ever-evolving world of technology.",
